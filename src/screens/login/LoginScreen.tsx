...
export class LoginScreen extends Component {
  ...
  private sendCredentials(): void {
    this.setState(prev => ({ ...prev, loginRequestProcessing: true })); // TODO read of how to set 1 state shorted and fix everywhere
  ...
  private processResponse(response: LoginResponse) {
    this.setState(prev => ({ ...prev, loginRequestProcessing: false }));
    if (response.error) {
  ...
  private showOnStackBar(message: string): void {
    this.setState(prev => ({ ...prev, snackBarMessage: message }))
  }
        ...
        <View style={ styles.contentContainer }>
          <View style={ styles.formContainer }>
            ...
            <TextInput
              ...
              onChangeText={ text => this.setState(prev => ({ ...prev, usernameControlValue: text })) }
            />
            ...
            <TextInput
              ...
              onChangeText={ text => this.setState(prev => ({ ...prev, passwordControlValue: text })) }
            />
          </View>
          ...
          <Button
            ...
            dark={ true }
            color={ Color.OCEAN }
            disabled={ this.anyRequiredCredAbsent }
